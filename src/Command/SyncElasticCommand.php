...
class SyncElasticCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): void
    {
        ...
        $yamlFilePath = "{$projectRoot}/config/packages/fos_elastica.yaml";
        ...
        $content .= Yaml::dump($this->config, 100);
        file_put_contents($yamlFilePath, $content);
        $this->io->success("Generated new config file: {$yamlFilePath}\nYou can now run \"fos:elastica:populate\".");
    }
